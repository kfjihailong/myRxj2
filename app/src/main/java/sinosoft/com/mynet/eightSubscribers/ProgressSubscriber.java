package sinosoft.com.mynet.eightSubscribers;
...
import sinosoft.com.mynet.twelveUtil.AppUtil;
...
public class ProgressSubscriber<T> extends Subscriber<T> {
    ...
    //    会到接口 这个监听 传来传去，最终，转到的他执行的地方。很不容易
    ...
    public ProgressSubscriber(BaseApi api) {
        this.showPorgress = api.isShowProgress();
